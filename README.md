...
✔ Connecting to an API: App queries the content.guardianapis.com api to fetch news stories related to the topic using api key.      
✔ Parsing the JSON response: The JSON response is parsed correctly, and relevant information is stored in the app.             
...
✔ Updating information regularly: When there is no data to display, the app shows a default textview that informs the user.            
✔ Using an AsyncTask      
